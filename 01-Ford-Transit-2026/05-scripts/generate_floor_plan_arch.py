...
# Position sink below center of galley zone (Z34 is 28-79, center is 53.5")
SK_X, SK_Y = GA_X0 + 2, GA_Y0 + (GA_L / 2) + 5  # sink below galley center (Y≈58.5-71.5)
...
MAT_D  = 55.0                  # north-south (55" depth)
# Align mattress to end at rear door (Y=155")
MAT_Y  = 155.0 - MAT_D         # Mattress starts at Y=100" to end at Y=155"
MAT_X  = (CW - MAT_W) / 2
# Bed platform dimensions (extends slightly beyond mattress)
BED_Y0 = MAT_Y - 1             # Platform starts 1" before mattress (Y=99")
BED_Y1 = Z2[1]                 # Platform ends at rear door (Y=155")
BED_D  = BED_Y1 - BED_Y0       # 56" platform depth
